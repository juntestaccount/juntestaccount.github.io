...
// After reading this blog article from Nicholas C. Zakas:
...
// https://developer.mozilla.org/en-US/docs/Web/API/Document/getElementsByClassName
        ...
        var dx = determineDx(pizzaContainerLength[0], size);
        var newwidth = (pizzaContainerLength[0].offsetWidth + dx) + 'px';
